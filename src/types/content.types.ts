...
/**
 * Socials page configuration.
 * @description Configuration for the Socials page, including metadata, navigation label, and feed settings.
 */
export interface Socials extends BasePageConfig {}
